...
<div class="d-flex">
    ...
    <div class="col-md-9">
        <div class="content-wrapper">
            ...
            <h1 class="mb-4">
                <i class="bi bi-lightning me-2"></i>Tambah Element
            </h1>
                ...
                <form action="{{ route('admin.elements.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" class="form-control @error('element_name') is-invalid @enderror" 
                               id="element_name" name="element_name" value="{{ old('element_name') }}" required
                               placeholder="Contoh: Pyro, Hydro, Anemo">
                        @error('element_name')
                            <div class="text-danger mt-2"><i class="bi bi-exclamation-circle me-1"></i>{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="file-upload">
                            ...
                            <input type="file" class="form-control @error('icon_url') is-invalid @enderror" 
                                   id="icon_url" name="icon_url" accept="image/*" required>
                        </div>
                        @error('icon_url')
                            <div class="text-danger mt-2"><i class="bi bi-exclamation-circle me-1"></i>{{ $message }}</div>
                        @enderror
                    ...
                    <div class="btn-group">
                        <button type="submit" class="btn btn-primary" style="flex: 1;">
                            <i class="bi bi-check-lg me-2"></i>Simpan Element
                        </button>
